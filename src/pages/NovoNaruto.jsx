...
const clasList = [
  { id: "aburame",   nome: "Clã Aburame",   icon: require("../assets/clas/Aburame.png"),   kekkei: "Kikaichuu / Kikai Ninpou",   descricao: "O clã Aburame é um dos mais importantes e conhecidos clãs de Konoha. Sua Kekkei Genkai permite aos membros do clã comungar seu corpo com pequenos insetos que se alimentam de chakra, os insetos kikai. Devido a essa comunhão, os membros do clã Aburame são capazes de controlar os insetos que vivem dentro de seu corpo, utilizando-os para realizar os mais diferentes tipos de jutsus, defensivos e ofensivos." },
  { id: "akimichi",  nome: "Clã Akimichi",  icon: require("../assets/clas/Akimichi.png"),  kekkei: "Baika no Jutsu",             descricao: "O clã Akimichi é um dos clãs nobres de Konoha. Membros desse clã possuem grande força física e são capazes de converter rapidamente calorias em chakra, que eles usam em suas técnicas secretas. A maioria destas técnicas consomem rapidamente o chakra do usuário durante o uso, e mantê-los durante uma batalha prolongada pode ser cansativo. Por isso, os Akimichi têm altos níveis de chakra e ingerem grande quantidade de comida, a fim de construir ou repor as suas reservas de chakra em forma de calorias. O hijutsu do clã concede a eles a capacidade de aumentar o tamanho de corpo, parcial ou totalmente." },
  { id: "fuuma",     nome: "Clã Fuuma",     icon: require("../assets/clas/Fuma.png"),      kekkei: "Tensai / Fuuma Shuriken",    descricao: "O Clã Fuuma é um clã ninja renomado, famoso no País do Fogo e na Vila Oculta da Chuva, embora não se saiba ao certo qual a sua origem. Seus membros são conhecidos por serem agressivos nos combates e por usarem as famosas Fuuma Shurikens, sendo os criadores destas armas e os mais especializados no uso delas." },
  { id: "hatake",    nome: "Clã Hatake",    icon: require("../assets/clas/Hatake.png"),    kekkei: "Genialidade",                descricao: "O clã Hatake é um pequeno, porém importante, clã de Konoha. Seus membros comumente são consagrados como grandes ninjas, dotados de capacidades excepcionais. O clã possui duas marcas características: a primeira é o contrato de invocação com os Cães Ninjas de Konoha; e a segunda é a Espada de Chakra Branco." },
  { id: "hoshigaki", nome: "Clã Hoshigaki", icon: require("../assets/clas/Hoshigaki.png"), kekkei: "Suiton / Predador Aquático", descricao: "O Clã Hoshigaki é um clã Shinobi de Kirigakure. Todos os membros deste clã têm características parecidas com tubarões, como dentes afiados e pontiagudos, e marcas faciais que se parecem com brânquias. A aparência por si só já denota que os Hoshigaki são especialistas em técnicas Suiton, sendo mortais quando lutam em áreas com grandes quantidades de água." },
  { id: "hozuki",    nome: "Clã Hōzuki",    icon: require("../assets/clas/Hōzuki.png"),    kekkei: "Suika no Jutsu",             descricao: "O Clã Hōzuki é uma família de ninjas da Vila Oculta da Névoa. Os membros deste clã possuem a capacidade de transformar seus corpos em estado líquido usando o Suika no Jutsu (Técnica de Hidrificação), uma técnica muito versátil que confere tanto poder quanto resistência. Seja para evitar um ataque inimigo, para se infiltrar em uma estrutura, ou para lançar um ataque surpresa em estado liquefeito, esta técnica possui um alto valor estratégico." },
  { id: "hyuuga",    nome: "Clã Hyuuga",    icon: require("../assets/clas/Hyuuga.png"),    kekkei: "Byakugan",                   descricao: "O clã Hyuuga é um dos mais nobres dentre os clãs de Konoha e também o que possui o sistema hierárquico interno mais rígido. Devido à sua poderosa kekkei genkai, os Hyuuga possuem o Taijutsu mais forte de todo o vilarejo: o Juuken." },
  { id: "inuzuka",   nome: "Clã Inuzuka",   icon: require("../assets/clas/Inuzuka.png"),   kekkei: "Shikakyu",                   descricao: "A marca principal desse clã é a afinidade que os membros possuem com os animais, mais precisamente cães e lobos. Toda criança Inuzuka deve ganhar ainda quando pequeno um cão ou um lobo que o seguirá como companheiro inseparável. A habilidade especial desse clã permite aos seus membros concentrar parte de seu chakra no nariz, aumentando a nível sobre-humano as suas capacidades olfativas." },
  { id: "kaguya",    nome: "Clã Kaguya",    icon: require("../assets/clas/Kaguya.png"),    kekkei: "Shikotsumyaku",              descricao: "O Clã Kaguya é um povo de bárbaros. Eles amam guerras e se recusam a desistir, mesmo quando não há saída, preferindo lutar apenas por diversão. O kekkei genkai do clã é o Shikotsumyaku (Pulso dos Ossos Mortais), uma habilidade poderosa e rara, mesmo dentro do clã, sendo temida por todos os membros." },
  ...
  { id: "nara",      nome: "Clã Nara",      icon: require("../assets/clas/Nara.png"),      kekkei: "Kagejutsu",                  descricao: "As habilidades desse clã encontram-se principalmente na grande capacidade de liderança, no talento estrategista e na criação de medicamentos. O clã possui uma criação de cervos, dos quais extraem boa parte das substâncias presentes em seus medicamentos. A arte secreta ninja do clã Nara permite aos seus membros manipular jutsus relacionados às sombras, cuja técnica básica consiste em imobilizar o adversário." },
  { id: "sarutobi",  nome: "Clã Sarutobi",  icon: require("../assets/clas/Sarutobi.png"),  kekkei: "Vontade do Fogo",            descricao: "O clã Sarutobi é um clã influente de Konoha. Deste clã normalmente surgem vários ninjas de renome que ocupam posições de alta autoridade. Os Sarutobi são extremamente leais à vila e devotos da Vontade do Fogo. Possuem grande resistência e talento com técnicas do tipo Katon, somente sendo rivalizados pelo clã Uchiha neste quesito. Outra importante marca do clã é o contrato de invocação com os Macacos Ninjas." },
  { id: "senju",     nome: "Clã Senju",     icon: require("../assets/clas/Senju.png"),     kekkei: "Mokuton",                    descricao: "O clã Senju foi um dos clãs responsáveis por fundar a Vila Oculta da Folha, juntamente com o rival clã Uchiha. Este clã era conhecido pela sua força e pelo fato de seus membros serem extremamente capazes, recebendo por isso o nome de Clã das Mil Habilidades. O maior ícone do clã Senju, Hashirama, foi conhecido por possuir grande vitalidade e, principalmente, por sua kekkei genkai, a manipulação do Mokuton (elemento madeira)." },
  { id: "shimura",   nome: "Clã Shimura",   icon: require("../assets/clas/Shimura.png"),   kekkei: "Fuuton / Fuuinjutsu",        descricao: "O Clã Shimura é um dos clãs shinobi de Konohagakure. Após sua formação, os Shimura estavam entre os primeiros a se aliarem à recém fundada vila dos Senju e Uchiha, ao lado do Clã Sarutobi. São conhecidos por suas notáveis habilidades de selamento e por suas potentes técnicas de Fuuton, bem como pela devoção e lealdade de seus integrantes, muitos dos quais lutaram e morreram nas guerras." },
  { id: "uchiha",    nome: "Clã Uchiha",    icon: require("../assets/clas/Uchiha.png"),    kekkei: "Sharingan",                  descricao: "Um dos mais famosos clãs de Konoha, o clã Uchiha é responsável pela proteção e segurança da vila, fazendo parte integral do policiamento da mesma. A kekkei genkai do clã, o Sharingan, é conhecida e cobiçada por povos além do país do fogo, tamanho é o seu poder." },
  { id: "uzumaki",   nome: "Clã Uzumaki",   icon: require("../assets/clas/Uzumaki.png"),   kekkei: "Chakra Expandido",           descricao: "O clã Uzumaki era um clã de destaque na Vila do Redemoinho. São conhecidos por possuir grande vitalidade, grande reserva de chakra e desenvolvimento notável em técnicas de selamento (fuuinjutsu)." },
  { id: "yamanaka",  nome: "Clã Yamanaka",  icon: require("../assets/clas/Yamanaka.png"),  kekkei: "Hijutsu Mental",             descricao: "O clã Yamanaka é um clã especializado em confundir o oponente, seja utilizando Genjutsu, seja através de Ninjutsu. A arte secreta ninja do clã permite aos seus membros manipular as mentes dos adversários com habilidade invejável, fazendo-os até mesmo lutarem entre si." },
  { id: "yotsuki",   nome: "Clã Yotsuki",   icon: require("../assets/clas/Yotsuki.png"),   kekkei: "Tensai / Lâmina da Lua",     descricao: "O Clã Yotsuki é um clã da Vila Oculta da Nuvem. Durante o mandato do Primeiro Raikage, o clã jurou lealdade à Vila e recebeu terras no Vale das Nuvens. Os membros deste clã são muito conhecidos pela sua lealdade, de modo que eles nunca traem ou revelam informações de seus companheiros." },
  { id: "yuki",      nome: "Clã Yuki",      icon: require("../assets/clas/Yuki.png"),      kekkei: "Hyouton (Gelo)",             descricao: "O Clã Yuki é oriundo do País da Água. Os membros deste clã são possuidores de uma poderosa kekkei genkai, o Hyouton (elemento Gelo), e por tal motivo participaram de intensas guerras civis, nas quais demonstraram sua força e passaram a ser temidos por ela." },
  { id: "sem_cla",   nome: "Sem Clã",       icon: null,                                    kekkei: "Hijutsu livre",              descricao: "Sem afiliação. Pode escolher Hijutsus especiais para ninjas independentes." },
];
